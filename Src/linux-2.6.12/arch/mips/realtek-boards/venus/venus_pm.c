...
/* Bit 0-3 of hwinfo represent CPU type */
		...
		#if 1	/* 09-03-11 change ir key code by ellion */
			powerkey_irrp = 0xE718F708;
			//powerkey_irrp = 0xED12F700;	// 09-09-02 for LABO-100 model
		#else
		...
		#if 1	/* 09-03-11 change ir key code by ellion */
			//ejectkey_irrp = 0xE718F708;
			ejectkey_irrp = 0xED12F700;	// 09-09-02 for LABO-100 model
		#else
