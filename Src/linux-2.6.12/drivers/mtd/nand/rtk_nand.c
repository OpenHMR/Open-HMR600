/******************************************************************************
 * $Id: rtk_nand.c 317223 2010-06-01 07:38:49Z alexchang2131 $
...
#define VERSION  "$Id: rtk_nand.c 317223 2010-06-01 07:38:49Z alexchang2131 $"
...
static unsigned int u32AddressBefore = 0;
...
//printk("[%s]databuf : 0x%x\n",__FUNCTION__,(unsigned long) data_buf);
