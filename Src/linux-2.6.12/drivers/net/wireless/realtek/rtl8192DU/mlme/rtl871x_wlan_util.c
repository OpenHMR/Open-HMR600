...
{
	{0x5e4322, 0x00a44f, 0x00a44f}, //atheros AP
	{0x5e4322, 0x00a44f, 0x5e4322}, //broadcom AP
	{0x3ea44f, 0x00a630, 0x3ea44f}, //cisco AP
	{0x5ea42b, 0x00a42b, 0x5ea42b}, //marvell AP
	{0x5ea422, 0x00a44f, 0x00a44f}, //ralink AP
	//{0x5ea44f, 0x5ea44f, 0x5ea44f}, //realtek AP
	{0x5e431c, 0x5e431c, 0x5e431c}, //realtek AP
	{0x5ea44f, 0x00a44f, 0x5ea44f}, //unknown AP
};
...
void SelectChannel(_adapter *padapter, unsigned char channel)
{
	...
	PHY_SwChnl8192C(padapter, channel);
	
}

void SetBWMode(_adapter *padapter, unsigned short bwmode, unsigned char channel_offset)
{
	PHY_SetBWMode8192C(padapter, (HT_CHANNEL_WIDTH)bwmode, channel_offset);
...
void _update_ampdu_factor(_adapter *padapter,unsigned char max_AMPDU_len)
{
	...
	u8	RegToSet_92D[4]={0x41,0x66,0x72,0xb9};
...
unsigned int is_ap_in_tkip(_adapter *padapter)
{
	...
	if (get_capability((NDIS_WLAN_BSSID_EX *)cur_network) & WLAN_CAPABILITY_PRIVACY)
	{
...
void Update_RA_Entry(_adapter *padapter, unsigned int cam_idx)
{
	...
	if(cam_idx != 4)//cam_idx is for broadcast
		pHalData->CurrentWirelessMode = networkType;

	init_rate = get_highest_rate_idx(mask&0x0fffffff)&0x3f;
...
void update_EDCA_param(_adapter *padapter)
{
	...
	if (prv_traffic_idx != trafficIndex)
	{
		...
		write32(padapter, REG_EDCA_BE_PARAM, 0x5ea42b/*EDCAParam[pmlmeinfo->assoc_AP_vendor][trafficIndex]*/);
...
void _update_related_bcn_reg(_adapter *padapter)
{
	...
	write8(padapter, REG_RD_CTRL+1, 0x6F);
