...
u32     RF_REG_FOR_5G_SWCHNL[13]={0,0x2f,0x30,0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39,0x0};
// Dual band 
u32     DMDP_RF_A_Path_1PHY_value_36_64[13]={0x72c15,0x96578,0x8893f,0xdd6f8,0x88ff0,0x11481,0xffaa0,0x006f8,0xaa47a,0x66f51,0xfefaa,0xfff9c,0x32c15};
u32     DMDP_RF_A_Path_1PHY_value_100_114[13]={0x72c15,0x965f8,0xcc93f,0xbb6c7,0xccff0,0x77481,0xffaa0,0x666c7,0x55fee,0x66f51,0xfefaa,0xff000,0x32c15};
u32     DMDP_RF_A_Path_1PHY_value_116_140[13]={0x72c15,0x965f8,0xcc93f,0xbb6c7,0xccff0,0x66488,0xddbd0,0x666c7,0x55fee,0x66f51,0xfefaa,0xe0000,0x32c15};
u32     DMDP_RF_A_Path_1PHY_value_149_165[13]={0x72c15,0x965f8,0xff923,0xbb6c7,0xffff0,0xff480,0xffaa0,0xcc6c7,0x55fef,0x66f51,0xfefaa,0xe0000,0x32c15};

u32     DMDP_RF_A_Path_2PHY_value_36_64[13]={0x72c15,0x967f8,0x8893f,0xdd6ff,0x88ff0,0x11481,0xffaa0,0x006c7,0xaa44e,0x66f51,0xffffe,0xfffe0,0x32c15};
u32     DMDP_RF_A_Path_2PHY_value_100_140[13]={0x72c15,0x167f8,0xcc906,0xbb6c1,0xccff0,0x77481,0xffaa0,0x666c7,0x5511b,0x66f51,0xfeffe,0xfc000,0x32c15};
u32     DMDP_RF_A_Path_2PHY_value_149_165[13]={0x72c15,0x96770,0xff907,0xbb6ff,0xffff0,0xff480,0xffac0,0xcc6c7,0x55ff0,0x76f51,0x7fffc,0xe387c,0x32c15};

// single phy
u32     SMSP_RF_A_Path_value_36_64[13]={0x72c15,0x96578,0x8893f,0xdd6f8,0x88ff0,0x11481,0xffaa0,0x006f8,0xaa47a,0x66f51,0xfffaa,0xfff9c,0x32c15};
u32     SMSP_RF_A_Path_value_100_114[13]={0x72c15,0x965f8,0xcc93f,0xbb6c7,0xccff0,0x77481,0xffaa0,0x666c7,0x55fee,0x66f51,0xfffaa,0xff000,0x32c15};
u32     SMSP_RF_A_Path_value_116_140[13]={0x72c15,0x965f8,0xcc93f,0xbb6c7,0xccff0,0x66488,0xddbd0,0x666c7,0x55fee,0x66f51,0xfffaa,0xe0000,0x32c15};
u32     SMSP_RF_A_Path_value_149_165[13]={0x72c15,0x965f8,0xff923,0xbb6c7,0xffff0,0xff480,0xffaa0,0xcc6c7,0x55fef,0x66f51,0xfffaa,0xe0000,0x32c15};

u32     SMSP_RF_B_Path_value_36_64[13]={0x72c15,0x96560,0x8893f,0xdd6f8,0x88ff0,0x11481,0xfeaa0,0x006f8,0xaa47e,0x66f51,0xfff02,0xfc020,0x32c15};
u32     SMSP_RF_B_Path_value_100_140[13]={0x72c15,0x965f8,0xcc938,0xbb6ff,0xccff0,0x77481,0xffaa0,0x666f9,0x55cff,0x66f51,0xfff02,0xfc000,0x32c15};
u32     SMSP_RF_B_Path_value_149_165[13]={0x72c15,0x96678,0xff938,0xbb6c7,0xffff0,0xff480,0xffaa0,0xcc6e7,0x5589a,0x66f51,0xfff02,0xe0000,0x32c15};
...
u8 getChnlGroupfromArray(u8 chnl)
{
	u8	group=0;
	...
	if (channel_info[chnl] < 3)			// Cjanel 1-3
		group = 0;
	...
	)
{
	...
	if(IS_HARDWARE_TYPE_8192D(pHalData)&&!pHalData->bPhyValueInitReady)
		return 0;
	...
	)
{
	HAL_DATA_TYPE	*pHalData = GET_HAL_DATA(Adapter);
	char		*pszMACRegFile;
	char		TestMacRegFile[] = RTL8192C_PHY_MACREG;
	char		sz88CMACRegFile[] = RTL8188C_PHY_MACREG;
	char		sz92CMACRegFile[] = RTL8192C_PHY_MACREG;
...
#else
		if(!IS_HARDWARE_TYPE_8192DE(pHalData))
	...
	)
{
	...
	char				szTestBBRegPgFile[] = RTL819X_PHY_REG_PG;
	
	char				sz88CBBRegFile[] = RTL8188C_PHY_REG;	
	char				sz88CAGCTableFile[] = RTL8188C_AGC_TAB;

	char				sz92CBBRegFile[] = RTL8192C_PHY_REG;	
	char				sz92CAGCTableFile[] = RTL8192C_AGC_TAB;

	char				szBBRegMpFile[] = RTL819X_PHY_REG_MP;

	char				sz88CTestBBRegFile[] = RTL8188C_PHY_REG;	
	char				sz88CTestAGCTableFile[] = RTL8188C_AGC_TAB;

	char				sz92CTestBBRegFile[] = RTL8192C_PHY_REG;
	char				sz92CTestAGCTableFile[] = RTL8192C_AGC_TAB;
	...
	char				*pszBBRegFile, *pszAGCTableFile, *pszAGCTable2File, *pszBBRegPgFile, *pszBBRegMpFile;
	...
	if(IS_HARDWARE_TYPE_8192D(pHalData)){
		...
		if(IS_92C_SERIAL(pHalData->VersionID))
		{
			if(IS_NORMAL_CHIP(pHalData->VersionID))
			{
				...
				pszBBRegPgFile = szBBRegPgFile;
			}
			else
			{
				pszBBRegFile=sz92CTestBBRegFile;
				pszAGCTableFile =sz92CTestAGCTableFile;
				pszBBRegPgFile= szTestBBRegPgFile;
			}
		}
		else
		{
			...
			{
				pszBBRegFile=sz88CTestBBRegFile;
				pszAGCTableFile =sz88CTestAGCTableFile;
				pszBBRegPgFile = szTestBBRegPgFile;
			}
		}

		pszBBRegMpFile = szBBRegMpFile;
	}
...
)
{
	...
	if(IS_NORMAL_CHIP(pHalData->VersionID))
	{
		...
		ptrArray = (u32*)Rtl819XMAC_Array;
		//RT_TRACE(COMP_INIT, DBG_LOUD, (" ===> phy_ConfigMACWithHeaderFile() Img:Rtl819XMAC_Array\n"));
	}
	else
	{
		//vivi modify for MAC header array, to ID 92d and 92c, 20100528
		if(IS_HARDWARE_TYPE_8192D(pHalData))
		{
			ArrayLength = MAC_2T_ArrayLength;
			ptrArray = (u32*)Rtl819XMAC_Array;
		...
		else
		{
			ArrayLength = MAC_2T_ArrayLength;
			ptrArray = (u32*)Rtl819XMAC_Array;
			//RT_TRACE(COMP_INIT, DBG_LOUD, (" ===> phy_ConfigMACWithHeaderFile() Img:Rtl8192CTestMAC_2T\n"));
		}
	}
	...
	if(IS_HARDWARE_TYPE_8192D(pHalData)){
		if(IS_NORMAL_CHIP(pHalData->VersionID))
		{
			if(pHalData->CurrentBandType92D == BAND_ON_2_4G)
			{
				...
				Rtl819XAGCTAB_Array_Table = (u32*)Rtl819XAGCTAB_2GArray;
			}
			else
			{
				AGCTAB_5GArrayLen = AGCTAB_5GArrayLength;
				Rtl819XAGCTAB_5GArray_Table = (u32*)Rtl819XAGCTAB_5GArray;
			}
			
			PHY_REGArrayLen = PHY_REG_Array_PGLength;
			Rtl819XPHY_REGArray_Table = (u32*)Rtl819XPHY_REG_Array_PG;
		}
		else
		{
			if(pHalData->CurrentBandType92D == BAND_ON_2_4G)
	...
	if(IS_HARDWARE_TYPE_8192D(pHalData)){
		...
		else
		{
			if(pHalData->interfaceIndex == 1){
				RadioA_ArrayLen = RadioB_1TArrayLength;
				Rtl819XRadioA_Array_Table = (u32*)Rtl819XRadioB_1TArray;
			}
			else
			{
				RadioA_ArrayLen = RadioA_1TArrayLength;
					...
					else
					{
						...
						else
						{
							...
							//MAC1 Read or Write  MAC0 reg. 0x352 BIT3: 1 acess reg. 0 pci config spcace
												//BIT2: 0: MAC0,1 MAC1 
							RT_TRACE(COMP_INIT,DBG_LOUD,("MAC1 Use DBI update 0x884!"));
	...
	IN BOOLEAN	bInitRF)
{
	...
	pHalData->CurrentBandType92D = Band;

	DBG_8192C("PHY_SwitchWirelessBand:BB Config Start!\n");
	...
	DBG_8192C("PHY_SwitchWirelessBand:BB Config Finished!\n");
	if(bInitRF){
		DBG_8192C("RF Config started!\n");
		PHY_SetBBReg(Adapter, 0x88c, 0x00f00000,  0xf);
		...
		PHY_SetBBReg(Adapter, 0x88c, 0x00f00000,  0);
		DBG_8192C("RF Config Finished!\n");
	}
#if DEV_BUS_TYPE == PCI_INTERFACE
	UpdateBBRFVal8192DE(Adapter);
#endif
#if DEV_BUS_TYPE == USB_INTERFACE
	_Update_BB_RF_FOR_92DU(Adapter);
#endif
...
static void _PHY_SwChnl8192C(PADAPTER Adapter, u8 channel)
{
	...
	if(pHalData->CurrentBandType92D != bandtype)
		PHY_SwitchWirelessBand(Adapter, bandtype, _FALSE);
	...
	for(eRFPath = 0; eRFPath <pHalData->NumTotalRFPath; eRFPath++)
	{
		...
		//RT_TRACE(COMP_MLME,DBG_LOUD,("phy_SwChnlStepByStep():set 0x18:%x.\n",pHalData->RfRegChnlVal[eRFPath]));
		//FIX ME!!!
		//PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, CurrentCmd->Para1, bRFRegOffsetMask, pHalData->RfRegChnlVal[eRFPath]);
		if(IS_HARDWARE_TYPE_8192D(pHalData)&&pHalData->CurrentBandType92D)
		{
			if(param2>99)
			{
				pHalData->RfRegChnlVal[eRFPath]=pHalData->RfRegChnlVal[eRFPath]|(BIT18)|BIT16|BIT8;
			}
			else
			{
				pHalData->RfRegChnlVal[eRFPath]=(pHalData->RfRegChnlVal[eRFPath]&(~BIT18))|BIT16|BIT8;
		...
		PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, param1, 0xFF, pHalData->RfRegChnlVal[eRFPath]);
#else
		...
		if(pHalData->CurrentBandType92D == BAND_ON_5G)
		{
			...
			{
				// fc area
				PHY_SetBBReg(Adapter, 0xD2C, BIT13|BIT14,  2);
			}
			else
			{
				// fc area
				PHY_SetBBReg(Adapter, 0xD2C, BIT13|BIT14,  1);
			}
		}
		else if(pHalData->CurrentBandType92D == BAND_ON_2_4G)	
		{
			// fc area
			PHY_SetBBReg(Adapter, 0xD2C, BIT13|BIT14,  0);	
		}

#if 1
		if(pHalData->CurrentBandType92D == BAND_ON_5G)
		{
			//Temply add for 5G band  verification , 36<=channel<=64 ,will removed when 5G check ok. suggested by yn
			//u32     RF_Reg[13]={0,0x2f,0x30,0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39,0x0};
			u8     reg_num;
			// Dual band 
			//u32     RF_A_Path_1PHY_value_36_64[13]={0x72c15,0x96578,0x8893f,0xdd6f8,0x88ff0,0x11481,0xffaa0,0x006f8,0xaa47a,0x66f51,0xfefaa,0xfff9c,0x32c15};
			//u32     RF_A_Path_1PHY_value_100_114[13]={0x72c15,0x965f8,0xcc93f,0xbb6c7,0xccff0,0x77481,0xffaa0,0x666c7,0x55fee,0x66f51,0xfefaa,0xff000,0x32c15};
			//u32     RF_A_Path_1PHY_value_116_140[13]={0x72c15,0x965f8,0xcc93f,0xbb6c7,0xccff0,0x66488,0xddbd0,0x666c7,0x55fee,0x66f51,0xfefaa,0xe0000,0x32c15};
			//u32     RF_A_Path_1PHY_value_149_165[13]={0x72c15,0x965f8,0xff923,0xbb6c7,0xffff0,0xff480,0xffaa0,0xcc6c7,0x55fef,0x66f51,0xfefaa,0xe0000,0x32c15};

			//u32     RF_A_Path_2PHY_value_36_64[13]={0x72c15,0x967f8,0x8893f,0xdd6ff,0x88ff0,0x11481,0xffaa0,0x006c7,0xaa44e,0x66f51,0xffffe,0xfffe0,0x32c15};
			//u32     RF_A_Path_2PHY_value_100_140[13]={0x72c15,0x167f8,0xcc906,0xbb6c1,0xccff0,0x77481,0xffaa0,0x666c7,0x5511b,0x66f51,0xfeffe,0xfc000,0x32c15};
			//u32     RF_A_Path_2PHY_value_149_165[13]={0x72c15,0x96770,0xff907,0xbb6ff,0xffff0,0xff480,0xffac0,0xcc6c7,0x55ff0,0x76f51,0x7fffc,0xe387c,0x32c15};

			// single phy
			//u32     RF_A_Path_value_36_64[13]={0x72c15,0x96578,0x8893f,0xdd6f8,0x88ff0,0x11481,0xffaa0,0x006f8,0xaa47a,0x66f51,0xfffaa,0xfff9c,0x32c15};
			//u32     RF_A_Path_value_100_114[13]={0x72c15,0x965f8,0xcc93f,0xbb6c7,0xccff0,0x77481,0xffaa0,0x666c7,0x55fee,0x66f51,0xfffaa,0xff000,0x32c15};
			//u32     RF_A_Path_value_116_140[13]={0x72c15,0x965f8,0xcc93f,0xbb6c7,0xccff0,0x66488,0xddbd0,0x666c7,0x55fee,0x66f51,0xfffaa,0xe0000,0x32c15};
			//u32     RF_A_Path_value_149_165[13]={0x72c15,0x965f8,0xff923,0xbb6c7,0xffff0,0xff480,0xffaa0,0xcc6c7,0x55fef,0x66f51,0xfffaa,0xe0000,0x32c15};

			//u32     RF_B_Path_value_36_64[13]={0x72c15,0x96560,0x8893f,0xdd6f8,0x88ff0,0x11481,0xfeaa0,0x006f8,0xaa47e,0x66f51,0xfff02,0xfc020,0x32c15};
			//u32     RF_B_Path_value_100_140[13]={0x72c15,0x965f8,0xcc938,0xbb6ff,0xccff0,0x77481,0xffaa0,0x666f9,0x55cff,0x66f51,0xfff02,0xfc000,0x32c15};
			//u32     RF_B_Path_value_149_165[13]={0x72c15,0x96678,0xff938,0xbb6c7,0xffff0,0xff480,0xffaa0,0xcc6e7,0x5589a,0x66f51,0xfff02,0xe0000,0x32c15};

			PHY_SetBBReg(Adapter, 0x800, BIT25|BIT24, 0);
			PHY_SetBBReg(Adapter, 0x88c, 0x00f00000,  0xf);

			if(param2>140){
				for(reg_num=0;reg_num<13;reg_num++)
				{
					if(eRFPath==0)
					{
						if(pHalData->MacPhyMode92D==DUALMAC_DUALPHY)
						{
							if(pHalData->interfaceIndex==0)
								PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,DMDP_RF_A_Path_1PHY_value_149_165[reg_num] );
							else
								PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,DMDP_RF_A_Path_2PHY_value_149_165[reg_num] );
						}
						else
							PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,SMSP_RF_A_Path_value_149_165[reg_num] );
					}
					else
						PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,SMSP_RF_B_Path_value_149_165[reg_num] );
				...
				for(reg_num=0;reg_num<13;reg_num++)
				{
					if(eRFPath==0)
					{
						...
						{
							if(pHalData->interfaceIndex==0)
								PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,DMDP_RF_A_Path_1PHY_value_116_140[reg_num] );
							else
								PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,DMDP_RF_A_Path_2PHY_value_100_140[reg_num] );
						}
						else
							PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,SMSP_RF_A_Path_value_116_140[reg_num] );
					}
					else
						PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,SMSP_RF_B_Path_value_100_140[reg_num] );
				}
			}
			else if(param2>64){
				for(reg_num=0;reg_num<13;reg_num++)
				{
					if(eRFPath==0)
					{
						...
						{
							if(pHalData->interfaceIndex==0)
								PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,DMDP_RF_A_Path_1PHY_value_100_114[reg_num] );
							else
								PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,DMDP_RF_A_Path_2PHY_value_100_140[reg_num] );
						}
						else
							PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,SMSP_RF_A_Path_value_100_114[reg_num] );
					}
					else
						PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,SMSP_RF_B_Path_value_100_140[reg_num] );
				}						
				...
				for(reg_num=0;reg_num<13;reg_num++)
				{
					if(eRFPath==0)
					{
						...
						{
							if(pHalData->interfaceIndex==0)
								PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,DMDP_RF_A_Path_1PHY_value_36_64[reg_num] );
							else
								PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,DMDP_RF_A_Path_2PHY_value_36_64[reg_num] );
						}
						else
							PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,SMSP_RF_A_Path_value_36_64[reg_num] );
					}
					else
						PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)eRFPath, RF_REG_FOR_5G_SWCHNL[reg_num], 0xfffff,SMSP_RF_B_Path_value_36_64[reg_num] );
				}						
			}

			PHY_SetBBReg(Adapter, 0x88c, 0x00f00000,  0);
			PHY_SetBBReg(Adapter, 0x800, BIT25|BIT24, 3);
	...
	)
{
	...
	if(IS_HARDWARE_TYPE_8192D(pHalData) && IS_92D_SINGLEPHY(pHalData->VersionID))
		PHY_SetBBReg(pAdapter, 0x874, bMaskDWord, 0x00208000);
	else //
		PHY_SetBBReg(pAdapter, 0x874, bMaskDWord, 0x22204000);

	if(IS_HARDWARE_TYPE_8192C(pHalData)){ //92d not do it,by luke
		if(is2T)
		{
			PHY_SetBBReg(pAdapter, 0x840, bMaskDWord, 0x00010000);
	...
	)
{
	...
	u32			ADDA_REG[IQK_ADDA_REG_NUM] = {	0x85c, 0xe6c, 0xe70, 0xe74,
 	...
 	pHalData->RegC08 = PHY_QueryBBReg(pAdapter, 0xc08, bMaskDWord);
 	pHalData->Reg874 = PHY_QueryBBReg(pAdapter, 0x874, bMaskDWord);
	pHalData->Reg88C = PHY_QueryBBReg(pAdapter, 0x88c, bMaskDWord);
	//Save AFE Parameters
	_PHY_SaveADDARegisters(pAdapter, ADDA_REG, pHalData->ADDA_backup);
	...
	if(!pHalData->bRfPiEnable)
		_PHY_PIModeSwitch(pAdapter, _TRUE);
	//TXIQK RF setting
	PHY_SetBBReg(pAdapter, 0x840, bMaskDWord, 0x01940000);
	PHY_SetBBReg(pAdapter, 0x844, bMaskDWord, 0x01940000);
	//BB setting
	PHY_SetBBReg(pAdapter, 0xc04, bMaskDWord, 0x03a05600);
	PHY_SetBBReg(pAdapter, 0xc08, bMaskDWord, 0x000800e4);
	PHY_SetBBReg(pAdapter, 0x874, bMaskDWord, 0x22208000);
	//AP or IQK
	PHY_SetBBReg(pAdapter, 0xb68, bMaskDWord, 0x0f600000);
	PHY_SetBBReg(pAdapter, 0xb6c, bMaskDWord, 0x0f600000);
	//IQK global setting
	...
	{
		//TXIQK RF setting
		PHY_SetBBReg(pAdapter, 0x840, bMaskDWord, 0x01900000);
		PHY_SetBBReg(pAdapter, 0x844, bMaskDWord, 0x01900000);
		//IQK global setting
		PHY_SetBBReg(pAdapter, 0xe28, bMaskDWord, 0x80800000);
		//path-A IQK setting
		PHY_SetBBReg(pAdapter, 0xe30, bMaskDWord, 0x14008c1f);
		...
		PHY_SetBBReg(pAdapter, 0xe4c, bMaskDWord, RX0REG0xe40);
		//Sleep(5) -> delay 1ms
		udelay_os(IQK_DELAY_TIME*1000);
		//LO calibration setting
	...
	if(TX1IQKOK == _TRUE)
	{
		...
		PHY_SetBBReg(pAdapter, 0x844, bMaskDWord, 0x01900000);
		//turn on external PA
		PHY_SetBBReg(pAdapter, 0x878, BIT(30), extPAon);
		//BB setting
		PHY_SetBBReg(pAdapter, 0x88c, bMaskDWord, 0xcc300080);
		//IQK global setting
		PHY_SetBBReg(pAdapter, 0xe28, bMaskDWord, 0x80800000);
		//path-A IQK setting
		PHY_SetBBReg(pAdapter, 0xe30, bMaskDWord, 0x14008c1f);
		...
		//load TX0 IMR setting
		PHY_SetBBReg(pAdapter, 0xe4c, bMaskDWord, RX1REG0xe40);
		//Sleep(5) -> delay 1ms
		udelay_os(IQK_DELAY_TIME*1000);
		//LO calibration setting
		PHY_SetBBReg(pAdapter, 0xe4c, bMaskDWord, 0x0046a911);
	...
	PHY_SetBBReg(pAdapter, 0x878, BIT(30), 0);
	//Exit IQK mode
	PHY_SetBBReg(pAdapter, 0xc04, bMaskDWord, pHalData->RegC04);
	PHY_SetBBReg(pAdapter, 0xc08, bMaskDWord, pHalData->RegC08);
	PHY_SetBBReg(pAdapter, 0x874, bMaskDWord, pHalData->Reg874);
	PHY_SetBBReg(pAdapter, 0x88c, bMaskDWord, pHalData->Reg88C);
	PHY_SetBBReg(pAdapter, 0xe28, bMaskDWord, 0x00000000);
	PHY_SetBBReg(pAdapter, 0x840, bMaskDWord, 0x00032d75);
	PHY_SetBBReg(pAdapter, 0x844, bMaskDWord, 0x00032d75);	
	if(!pHalData->bRfPiEnable)
		_PHY_PIModeSwitch(pAdapter, _FALSE);
	//Reload ADDA power saving parameters
	_PHY_ReloadADDARegisters(pAdapter, ADDA_REG, pHalData->ADDA_backup);
...
BOOLEAN _PHY_QueryRFPathSwitch(
	IN	PADAPTER	pAdapter,
	IN	BOOLEAN		is2T
	)
{
                ...
                )
{
	...
	u8				RF_path;
	u32				value4;
// update BB /RF related value for 92D  zhiyuan 2010/04/07
#if DISABLE_BB_RF
	return;
#endif
	...
	DBG_8192C("==>Update BB RF Related value after BB/RF config for 92DU\n");

	if(pHalData->CurrentBandType92D == BAND_ON_5G)
	{
		// select 5G for path A
		PHY_SetBBReg(Adapter, 0x878, BIT0,  1);
		// RSSI table select
		PHY_SetBBReg(Adapter, 0xC78, BIT6|BIT7,  1);
		//5G PA power on
		PHY_SetBBReg(Adapter, 0x878, BIT15,  1);
		// fc area
		//PHY_SetBBReg(Adapter, 0xD2C, BIT13|BIT14,  1);
		//AGC trsw threshold
		PHY_SetBBReg(Adapter, 0xc70, 0x007f0000, 0x4e);
	}
	else
	{
		PHY_SetBBReg(Adapter, 0x878, BIT0,  0);
		PHY_SetBBReg(Adapter, 0xC78, BIT6|BIT7,  0);
		//5G PA power off
		PHY_SetBBReg(Adapter, 0x878, BIT15,  0);
		//PHY_SetBBReg(Adapter, 0xD2C, BIT13|BIT14,  0);
		PHY_SetBBReg(Adapter, 0xc70, 0x007f0000, 0x7f);
	}
	...
	if(!IS_NORMAL_CHIP(pHalData->VersionID))
	{
		...
		{
			// TX BB gain shift
			PHY_SetBBReg(Adapter, 0xc80, 0xffffffff, 0x20000080);
		}
		else
		{
			PHY_SetBBReg(Adapter, 0xc80, 0xffffffff, 0x40000100);
		}
	}
	...
	{
	       // 1.5V LDO  0x14[23:20]
	       value4=read32(Adapter,0x14);
		value4=(value4&0xff0fffff)|0x00d00000;
		write32(Adapter,0x14,value4);
		// RF CONFIG
		write8(Adapter,0xc04,0x11);
		write8(Adapter,0xd04,0x01);
		// enalbe ad/da clock 1 for Dual phy
		PHY_SetBBReg(Adapter, 0x888, 0x3000,  BIT1|BIT0);
		// 2T2R mode  0x38[12]
		PHY_SetRFReg(Adapter, PathA, 0x38, 0x1000, 0);
		// set cck control for DMDP ,the default value of 0x884 bit11 is 0 ,so set it to 1
		PHY_SetBBReg(Adapter, rFPGA0_AnalogParameter2, BIT11, 1);// SET  BIT11  for receive cck
	...
	else
	{
		if(pHalData->CurrentBandType92D == BAND_ON_5G)
		{
			...
			write32(Adapter,0x14,value4);
			// select 5G for path A
			PHY_SetBBReg(Adapter, 0x878, BIT0|BIT16,  BIT0|BIT16);

			//5G PA power on
			PHY_SetBBReg(Adapter, 0x878, BIT31,  1);
		}
		else
		{
			 // 1.5V LDO  0x14[23:20]
		       value4=read32(Adapter,0x14);
			value4=(value4&0xff0fffff)|0x00700000;
			write32(Adapter,0x14,value4);
			PHY_SetBBReg(Adapter, 0x878, BIT0|BIT16,  0);

			//5G PA power on
			PHY_SetBBReg(Adapter, 0x878, BIT31,  0);
		}
		...
		if(!IS_NORMAL_CHIP(pHalData->VersionID))
		{
			...
			{
				// TX BB gain shift
				PHY_SetBBReg(Adapter, 0xc88, 0xffffffff, 0x20000080);
			}
			else
			{
				PHY_SetBBReg(Adapter, 0xc88, 0xffffffff, 0x40000100);
			}
		}

		write8(Adapter,0xc04,0x33);
		write8(Adapter,0xd04,0x03);		
		PHY_SetBBReg(Adapter, 0x888, 0x3000, 0);		
		PHY_SetRFReg(Adapter, PathA, 0x38, 0x1000, 1);
	}
	
	for(RF_path=0;RF_path<pHalData->NumTotalRFPath;RF_path++)
	{
		pHalData->RfRegChnlVal[RF_path] = PHY_QueryRFReg(Adapter, (RF90_RADIO_PATH_E)RF_path, RF_CHNLBW, bRFRegOffsetMask);
		if(pHalData->CurrentBandType92D == BAND_ON_5G)
		{
			pHalData->RfRegChnlVal[RF_path]=pHalData->RfRegChnlVal[RF_path]|(BIT16|BIT8);
	              // RF Tx Power control  0x28[7:6]  2'b01
			PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)RF_path, 0x28, 0xc0 , 1);
			// A/G MODE LO buffer  5G:0x38[16:14]=3'b011;
			PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)RF_path, 0x38, 0x0001c000 , 3);
			// RF 0x38[19]  peak detector
			PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)RF_path, 0x38, 0x00080000 , 1);
		}
		else
		{
			pHalData->RfRegChnlVal[RF_path]=pHalData->RfRegChnlVal[RF_path]&0xfffefc00;
			// RF Tx Power control  0x28[7:6]  2'b00
			PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)RF_path, 0x28, 0xc0 , 0);
			// A/G MODE LO buffer   2G:0x38[16:14]=3'b100;
			PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)RF_path, 0x38, 0x0001c000 , 0x4);
			// RF 0x38[19]  peak detector
			PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)RF_path, 0x38, 0x00080000 , 0);
		}
		PHY_SetRFReg(Adapter, (RF90_RADIO_PATH_E)RF_path, RF_CHNLBW, bRFRegOffsetMask , pHalData->RfRegChnlVal[RF_path]);	
	}

	//turn on or off cck clock
	if(pHalData->CurrentBandType92D == BAND_ON_5G)
	{
