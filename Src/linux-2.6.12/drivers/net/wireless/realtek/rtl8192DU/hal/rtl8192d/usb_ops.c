...
void usb_writeN(struct intf_hdl *pintfhdl, u32 addr, u32 length, u8 *pdata)
{
	...
	usbctrl_vendorreq(pintfpriv, request, wvalue, index, buf, len, requesttype);
	
	_func_exit_;
	
}

void usb_async_write8(struct intf_hdl *pintfhdl, u32 addr, u8 val)
{	
	u32 data;
	struct intf_priv *pintfpriv = pintfhdl->pintfpriv;
...
void usb_async_write16(struct intf_hdl *pintfhdl, u32 addr, u16 val)
{	
	u32 data;
	struct intf_priv *pintfpriv = pintfhdl->pintfpriv;
	struct dvobj_priv  *pdvobjpriv = (struct dvobj_priv  *)pintfpriv->intf_dev;
...
void usb_async_write32(struct intf_hdl *pintfhdl, u32 addr, u32 val)
{	
	u32 data;
	struct intf_priv *pintfpriv = pintfhdl->pintfpriv;
	struct dvobj_priv  *pdvobjpriv = (struct dvobj_priv  *)pintfpriv->intf_dev;
