...
#if (HARDWARE_TYPE_IS_RTL8192D == 1)	//For 92D efuse content.
...
#define EEPROM_CCK_TX_PWR_INX_2G						0x63
#define EEPROM_HT40_1S_TX_PWR_INX_2G					0x69
#define EEPROM_HT40_2S_TX_PWR_INX_DIFF_2G			0x6F
#define EEPROM_HT20_TX_PWR_INX_DIFF_2G				0x72
#define EEPROM_OFDM_TX_PWR_INX_DIFF_2G				0x75
#define EEPROM_HT40_MAX_PWR_OFFSET_2G				0x78
#define EEPROM_HT20_MAX_PWR_OFFSET_2G				0x7B

//5GL channel 32-64
#define EEPROM_HT40_1S_TX_PWR_INX_5GL				0x7E
#define EEPROM_HT40_2S_TX_PWR_INX_DIFF_5GL			0x84
#define EEPROM_HT20_TX_PWR_INX_DIFF_5GL				0x87
#define EEPROM_OFDM_TX_PWR_INX_DIFF_5GL				0x8A
#define EEPROM_HT40_MAX_PWR_OFFSET_5GL				0x8D
#define EEPROM_HT20_MAX_PWR_OFFSET_5GL				0x90

//5GM channel 100-140
#define EEPROM_HT40_1S_TX_PWR_INX_5GM				0x93
#define EEPROM_HT40_2S_TX_PWR_INX_DIFF_5GM			0x99
#define EEPROM_HT20_TX_PWR_INX_DIFF_5GM				0x9C
#define EEPROM_OFDM_TX_PWR_INX_DIFF_5GM				0x9F
#define EEPROM_HT40_MAX_PWR_OFFSET_5GM				0xA2
#define EEPROM_HT20_MAX_PWR_OFFSET_5GM				0xA5

//5GH channel 149-165
#define EEPROM_HT40_1S_TX_PWR_INX_5GH				0xA8
#define EEPROM_HT40_2S_TX_PWR_INX_DIFF_5GH			0xAE
#define EEPROM_HT20_TX_PWR_INX_DIFF_5GH				0xB1
#define EEPROM_OFDM_TX_PWR_INX_DIFF_5GH				0xB4
#define EEPROM_HT40_MAX_PWR_OFFSET_5GH				0xB7
#define EEPROM_HT20_MAX_PWR_OFFSET_5GH				0xBA

#define EEPROM_CHANNEL_PLAN						0xBD // Map of supported channels.	

#define EEPROM_TSSI_A_2G						0xBE
#define EEPROM_TSSI_B_2G						0xBF
#define EEPROM_TSSI_A_5G						0xC0
#define EEPROM_TSSI_B_5G						0xC1
#define EEPROM_TSSI_AB_5G						0xC2
#define EEPROM_THERMAL_METER					0xC5	//[4:0]
#define EEPROM_XTAL_K							0xC5	//[7:5]
#define EEPROM_RF_OPT1							0xC6
#define EEPROM_RF_OPT2							0xC7
#define EEPROM_RF_OPT3							0xC8
#define EEPROM_RF_OPT4							0xC9
#define EEPROM_RF_OPT5							0xCA
#define EEPROM_RF_OPT6							0xCB
#define EEPROM_VERSION							0xCC
#define EEPROM_CUSTOMER_ID						0xCD
...
#define EEPROM_MAC_ADDR_MAC1_92D				0x5D
//----------------------------------------------------------------
// 2.4G band Tx power index setting
#define EEPROM_CCK_TX_PWR_INX_2G						0x63
#define EEPROM_HT40_1S_TX_PWR_INX_2G					0x69
...
#define EEPROM_CHANNEL_PLAN						0xBD // Map of supported channels.	
#define EEPROM_TEST_CHANNEL_PLAN					0xBD
...
//---------------------------------------------------------------
#define EEPROM_TEST_USB_OPT1					0x0E
#define EEPROM_TEST_USB_OPT2					0x0F
#define EEPROM_TEST_CHIRP_K						0x0F
#define EEPROM_TEST_EP_SETTING					0x0E
#define EEPROM_TEST_USB_PHY						0x10
#define EEPROM_TEST_XTAL_K						0x75
#define EEPROM_TEST_CHANNEL_PLAN				0x7D
#define	EEPROM_TEST_BoardType					EEPROM_RF_OPT4 //[3:0]
...
#define EEPROM_NORMAL_TEST_XTAL_K				0x78 //[7:5]
#define	EEPROM_NORMAL_BoardType					EEPROM_RF_OPT1	//[7:5]
#endif
//-------------------------------------------------------------
