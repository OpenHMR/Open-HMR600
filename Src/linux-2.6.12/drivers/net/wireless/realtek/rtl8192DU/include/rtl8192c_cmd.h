...
#define GEN_DRV_CMD_HANDLER(size, cmd)		{size, &r871x_ ## cmd ## _hdl},
//#define GEN_DRV_CMD_HANDLER(size, cmd)		{size, &cmd ## _hdl},
//#define GEN_MLME_EXT_HANDLER(size, cmd)	{size, &r871x_ ## cmd ## _hdl},
...
u8 r871x_disconnect_hdl(_adapter *padapter, u8 *pbuf);
u8 r871x_createbss_hdl(_adapter *padapter, u8 *pbuf);
u8 r871x_setopmode_hdl(_adapter *padapter, u8 *pbuf);
u8 r871x_sitesurvey_cmd_hdl(_adapter *padapter, u8 *pbuf);	
u8 r871x_setauth_hdl(_adapter *padapter, u8 *pbuf);
u8 r871x_setkey_hdl(_adapter *padapter, u8 *pbuf);
u8 r871x_set_stakey_hdl(_adapter *padapter, u8 *pbuf);
u8 r871x_set_assocsta_hdl(_adapter *padapter, u8 *pbuf);
u8 r871x_del_assocsta_hdl(_adapter *padapter, u8 *pbuf);
...
struct cmd_hdl wlancmds[] = 
{
	...
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL)		
	GEN_MLME_EXT_HANDLER(sizeof (struct joinbss_parm), r871x_join_cmd_hdl) /*14*/
	GEN_MLME_EXT_HANDLER(sizeof (struct disconnect_parm), r871x_disconnect_hdl)
	GEN_MLME_EXT_HANDLER(sizeof (struct createbss_parm), r871x_join_cmd_hdl)
	GEN_MLME_EXT_HANDLER(sizeof (struct setopmode_parm), r871x_setopmode_hdl)
	GEN_MLME_EXT_HANDLER(sizeof (struct sitesurvey_parm), r871x_sitesurvey_cmd_hdl) /*18*/
	GEN_MLME_EXT_HANDLER(sizeof (struct setauth_parm), r871x_setauth_hdl)
	GEN_MLME_EXT_HANDLER(sizeof (struct setkey_parm), r871x_setkey_hdl) /*20*/
	GEN_MLME_EXT_HANDLER(sizeof (struct set_stakey_parm), r871x_set_stakey_hdl)
	...
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(sizeof(struct addBaReq_parm), r871x_add_ba_hdl)	
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL)
	GEN_MLME_EXT_HANDLER(0, NULL)
	...
	GEN_MLME_EXT_HANDLER(0, r871x_mlme_evt_hdl) /*56*/
	GEN_MLME_EXT_HANDLER(0, r871x_drvextra_cmd_hdl) /*57*/

	GEN_MLME_EXT_HANDLER(0, r871x_h2c_msg_hdl) /*58*/
