...
int _init_hw_txqueue(struct hw_txqueue* phw_txqueue, u8 ac_tag);
void	_init_sta_xmit_priv(struct sta_xmit_priv *psta_xmitpriv);
int update_attrib(_adapter *padapter, _pkt *pkt, struct pkt_attrib *pattrib);


int txframes_pending(_adapter *padapter);
