...
#define LINKED_TO (2) //unit:2 sec, 2x2=4 sec
...
struct mlme_ext_info
{
	...
	WLAN_BSSID_EX network;//join network
...
struct mlme_ext_priv
{
	...
	struct mlme_ext_info	mlmext_info;//for sta/adhoc mode, currently scanning/connecting/connected related info.

		
	//_queue		assoc_sta_queue;
