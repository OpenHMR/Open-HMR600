...
#define	MAX_FIRMWARE_CODE_SIZE	0xFF00  // Firmware Local buffer size.  //64k

// Fixed length of H2C Tx Cmd header length = CMD_LEN(16 bits) + CMD_ID (8 bits) + CMD_SEQ(7 bits) + CONTINUE(1 bit) + Reserved(32 bits)
...
//---------------------------------------------------------------------------
// Check  RTL8192S Firmware related. Added by Roger, 2008.12.18.
//---------------------------------------------------------------------------
bool FirmwareEnableCPU(struct net_device *dev);
bool FirmwareCheckReady(struct net_device *dev, u8 LoadFWStatus);

//---------------------------------------------------------------------------
// RTL8192S Firmware related function prototype. Added by Roger, 2008.12.18.
//---------------------------------------------------------------------------
