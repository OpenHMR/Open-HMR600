...
#define		EPROM_CMD			0x000A	// 93C46/93C56 Command Register.
...
//
#define		INTA_MASK				0x0300	// Interrupt Mask Register
...
#define		RDQDA				0x053C	// Receive Desc Starting Addr
...
//#define		RPWM				0x0561	// Host Request Power Mode.
...
#define 	TX_PWR_SAFETY_CHK		0x6D// Check if power safety spec is need
...
#define		EEPROM_BLUETOOTH_COEXIST		0x78 // 92se, 0x78[1]
...
//cosa #define 	EEPROM_TX_PWR_BAND_EDGE	0x73// TX Power offset at band-edge channel
#define 	TX_PWR_SAFETY_CHK			0x79// Check if power safety is need
#endif
...
#endif // #ifndef __INC_HAL8192SREG_H
