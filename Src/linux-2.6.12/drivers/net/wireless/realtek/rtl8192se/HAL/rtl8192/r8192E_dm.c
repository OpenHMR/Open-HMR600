...
#ifdef RTL8192E
static u32 edca_setting_DL[HT_IOT_PEER_MAX] = 
{ 0x5e4322, 	0x5e4322, 	0x5e4322, 	0x604322, 	0xa44f, 	0x5e4322,	0x5e4332};
static u32 edca_setting_UL[HT_IOT_PEER_MAX] = 
{ 0x5e4322, 	0xa44f,		0x5e4322,  	0x604322, 	0x5e4322, 	0x5e4322,	0x5e4332};
#elif defined(RTL8192SE)
static u32 edca_setting_DL[HT_IOT_PEER_MAX] = 
// UNKNOWN		REALTEK_90	REALTEK_92SE	BROADCOM		RALINK		ATHEROS		CISCO		MARVELL		92U_AP		SELF_AP
{ 0x4322, 		0xa44f, 		0x5ea44f,		0xa42b/*0xa630*/, 			0x5e4322, 	0x4322, 		0xa430,		0xa44f/*0xa44f*/,		0x5e4322,		0x5e4322};
static u32 edca_setting_UL[HT_IOT_PEER_MAX] = 
// UNKNOWN		REALTEK_90	REALTEK_92SE	BROADCOM		RALINK		ATHEROS		CISCO		MARVELL		92U_AP		SELF_AP
{ 0x5e4322, 		0x5ea44f,	0x5ea44f,		0x5e4322,  		0x5e4322, 	0x5e4322, 	0x3ea44f,		0x5ea44f,		0x5e4322,		0x5e4322};
#endif
#endif
...
#else
	tq_init(&priv->gpio_change_rf_wq, (void(*)(void*)) dm_gpio_change_rf_callback,dev);	
#endif
#endif
	...
	if (pHalData->bForcedUsbRxAggr) {
		if (pHalData->ForcedUsbRxAggrInfo == 0) {
			if (pHalData->bCurrentRxAggrEnable) {
				dev->HalFunc.HalUsbRxAggrHandler(dev, FALSE);
			}
		} else {
			if (!pHalData->bCurrentRxAggrEnable || (pHalData->ForcedUsbRxAggrInfo != pHalData->LastUsbRxAggrInfoSetting)) {
				dev->HalFunc.HalUsbRxAggrHandler(dev, TRUE);
			}
		}
		return;
	}
...
static void dm_CheckTXPowerTracking_ThermalMeter(struct net_device *dev)
{
	...
	for(i=0; i<50; i++)
	{
		tmpRegA = PHY_QueryRFReg(dev, RF90_PATH_A, 0x12, 0x078);	// 0x12: RF Reg[10:7]
	...
	struct net_device * dev)
{
	...
	
	{
		...
		static int wb_tmp = 0;
		if (wb_tmp == 0){
			printk("========>%s():iot peer is %s, bssid:"MAC_FMT"\n",__FUNCTION__,peername[pHTInfo->IOTPeer], MAC_ARG(priv->ieee80211->current_network.bssid));
			wb_tmp = 1;
		}
	}
...
extern void dm_gpio_change_rf_callback(struct net_device *dev)
{
	...
	if((!priv->up) || (priv->being_init_adapter))// || RT_IS_FUNC_DISABLED(pAdapter, DF_IO_BIT))
	{
