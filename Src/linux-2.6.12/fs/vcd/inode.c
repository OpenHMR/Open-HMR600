...
static int find_cd_info_in_toc( struct super_block *sb )
{
	...
	strcat(proc_data_content.cd_type, " DATE 0606\n");
...
static int fill_tracks_in_super(struct super_block *sb,int mounting_acd)
{
	...
	// Assume no bad_sector exists
	this_cd->bad_sector=5000000;
...
root_found:
	...
	*/
	...
	printk("<vcd module> mount disc with vcd module SP OK for VCD/SVCD/Data........0606\n");
	switch (CD_TYPE)
	{
...
//Free that shoud be freed first
	...
	*/
	...
	printk("<vcd module> mount disc with vcd module SP OK for Audio CD........0606\n");
	#ifdef CONFIG_USE_CDDA_SUBCHANNEL
...
#else
	printk("<vcd module> TYPE ACD2352 NO USE CDDA SUBCHANNEL 0606\n");
#endif
